// app/projects/endless-runner/page.tsx
    ...
    <main className="root">
      <div className="content-layer">
        <header className="hero" style={{ paddingTop: "1.5rem" }}>
          <div className="hero-label">EXPERIMENT / CHUNK GENERATION</div>
          <h1 className="hero-title">
            <span className="hero-name">Endless Runner</span>
            <span className="hero-sub">
              A first attempt at chunk based level generation.
            </span>
          </h1>
